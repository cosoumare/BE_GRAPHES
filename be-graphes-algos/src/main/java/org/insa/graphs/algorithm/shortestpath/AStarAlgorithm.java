...
public class AStarAlgorithm extends DijkstraAlgorithm {
    ...
    protected ShortestPathSolution doRun() {
        ...
        Label[] Tablab = new LabelStar[nbNodes];
        ...
        for (int i =0; i<nbNodes; i++) {
        	if (data.getGraph().get(i).equals(data.getOrigin())) {
        		...
        		Label lab =new LabelStar(i, false, 0, null,data.getDestination().getPoint().distanceTo(data.getGraph().get(i).getPoint()));
        		lab.setSommetC(data.getGraph().get(i).getId());
        		Tablab[i]=lab;
        		Tas.insert(lab);
        	}else {
        		Label lab =new LabelStar(i, false, inf, null,data.getDestination().getPoint().distanceTo(data.getGraph().get(i).getPoint()));
        		lab.setSommetC(data.getGraph().get(i).getId());  
        		Tablab[i]=lab;
        	}
        }
       ...
       while ((!(Tas.isEmpty())) && !fin) {   	   
        ...
        System.out.println("son cout est: "+x.getCost());
        System.out.println("");
